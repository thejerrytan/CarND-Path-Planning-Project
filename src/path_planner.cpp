...
pairOfList Planner::generatePath(double targetSpeed, int targetLane, int givenAppendIdx, double timeHorizon) {
...
pairOfList Planner::extendPath(double targetSpeed, int targetLane) {
